...
const Feature5 = () => {
  return (
    <section className="mt-64 flex justify-between items-center gap-y-10 px-4 sm:px-10 md:px-20 lg:px-[120px]">
      <Image
      ...
      <div className={"flex items-center justify-center"}>
        ...
        >
          <Image src={"/diagram.png"} alt={"rollup"} width={400} height={400} />
          <h1 className="text-black font-extrabold sm:text-3xl text-lg">
            Build stunning whiteboards for free
          </h1>
          <p className="mt-2 text-gray-700 text-[12px] max-w-[250px] sm:text-[16px] sm:max-w-[1200px text-center]">
            It’s as simple as one-two-three, and guess what? You don’t even need
